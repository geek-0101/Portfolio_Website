...
document.querySelectorAll('.filter-btn').forEach(btn =>{
    btn.addEventListener('click',()=>{
        //when a filter is clicked, it clears the active class from all 
        //filter buttons and then adds it to the current filter
        document.querySelectorAll('.filter-btn').forEach(b =>
            b.classList.remove('active'));
            btn.classList.add('active');
            //when element with "data-*" attribute is cllicked, js removes the prefix
            //and adds the rest of the attribute name into property on dataset object
